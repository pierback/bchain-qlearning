module github.com/pierback/bchain-qlearning
...
require (
	...
	github.com/dmichael/go-multicast v0.0.0-20170412170512-0421e0ed8695 // indirect
	...
	github.com/grandecola/mmap v0.2.0 // indirect
