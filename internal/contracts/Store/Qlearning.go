...
const StoreABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"bytes32\"}],\"name\":\"items\",\"outputs\":[{\"name\":\"\",\"type\":\"bytes32\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"version\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"key\",\"type\":\"bytes32\"}],\"name\":\"getItems\",\"outputs\":[{\"name\":\"\",\"type\":\"bytes32\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"key\",\"type\":\"bytes32\"},{\"name\":\"value\",\"type\":\"bytes32\"}],\"name\":\"setItem\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"_version\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"key\",\"type\":\"bytes32\"},{\"indexed\":false,\"name\":\"value\",\"type\":\"bytes32\"}],\"name\":\"ItemSet\",\"type\":\"event\"}]"

// StoreBin is the compiled bytecode used for deploying new contracts.
const StoreBin = `Binary:
`
...
// GetItems is a free data retrieval call binding the contract method 0xa9960f77.
//
// Solidity: function getItems(key bytes32) constant returns(bytes32)
func (_Store *StoreCaller) GetItems(opts *bind.CallOpts, key [32]byte) ([32]byte, error) {
	var (
		ret0 = new([32]byte)
	)
	out := ret0
	err := _Store.contract.Call(opts, out, "getItems", key)
	return *ret0, err
}
...
//
// Solidity: function getItems(key bytes32) constant returns(bytes32)
func (_Store *StoreSession) GetItems(key [32]byte) ([32]byte, error) {
	return _Store.Contract.GetItems(&_Store.CallOpts, key)
}

// GetItems is a free data retrieval call binding the contract method 0xa9960f77.
//
// Solidity: function getItems(key bytes32) constant returns(bytes32)
func (_Store *StoreCallerSession) GetItems(key [32]byte) ([32]byte, error) {
	return _Store.Contract.GetItems(&_Store.CallOpts, key)
}
